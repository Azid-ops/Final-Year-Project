...
import EleventhResultPage from "../pages/eleventh";

const EleventhClassResult = () => {
    ...
    const uploadMarks =async (fullName,institutionName,rollNumber) => {
        ...
        await fetch("/uploadResult", {
            ...
            body:JSON.stringify({
                physics,chemistry,computer,urdu,english,pakistanStudies,islamiat,fullName,institutionName,rollNumber,myClass:"11th"
            })
        });
    }
...
export default EleventhClassResult;