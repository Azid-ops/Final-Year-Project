...
import TwelethResultPage from "../pages/tweleth";
...
const TwelethClassResult = () => {
    ...
    const uploadMarks =async (fullName,institutionName,rollNumber) => {
        ...
        await fetch("/uploadResult", {
            ...
            body:JSON.stringify({
                physics,chemistry,computer,urdu,english,pakistanStudies,islamiat,fullName,institutionName,rollNumber,myClass:"12th"
            })
        });
    }
...
export default TwelethClassResult;