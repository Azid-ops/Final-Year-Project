...
const EleventhResultPage = (props) => {
    return(
        <Aux>
            <section className="outer__body">
                <section className="left__body">
                    ...
                    <div className="left__Body">
                        <div onClick={props.eleventhClassNavigation} className="dashboard__btn__active">
                    ...
                    <div className="left__Body">
                        <div onClick={props.twelethClassNavigation} className="dashboard__btn">
...
export default EleventhResultPage;