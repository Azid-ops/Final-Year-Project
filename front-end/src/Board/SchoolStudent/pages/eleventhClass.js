        ...
        <Aux>
            <section className="outer__body">
                <section className="left__body">
                    ...
                    <div className="left__Body">
                        <div onClick={props.tenthClass} className="dashboard__btn">
                            <FontAwesomeIcon style={{marginTop:"0.1rem"}}icon={faSchool} />
                    ...
                    <div className="left__Body">
                        <div onClick={props.eleventhClass} className="dashboard__btn__active">
                            <FontAwesomeIcon style={{marginTop:"0.1rem"}}icon={faSchool} />
...
export default EleventhClassPage;